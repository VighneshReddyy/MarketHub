...
-- ItemMedia - Insert your own data
...
-- Reports
INSERT INTO Reports (item_id, reported_user_id, reported_by, reason, status) VALUES
(1, 1, 3, 'Item description is misleading', 'pending'),
(2, 2, 1, 'Overpriced compared to market', 'resolved'),
(3, 3, 2, 'Images do not match actual product', 'pending'),
(4, 1, 5, 'Seller not responding after inquiry', 'pending'),
(5, 5, 2, 'Duplicate listing detected', 'resolved'),
(NULL, 2, 1, 'User is spamming messages', 'pending'),
(NULL, 5, 3, 'Suspicious behavior from this user', 'ignored'),
(NULL, 1, 3, 'Rude communication during negotiation', 'pending'),
(NULL, 3, 2, 'User frequently cancels orders', 'pending'),
(1, 1, 2, 'Possible fake product listing', 'pending'),
(2, 2, 5, 'Seller provided incorrect details', 'resolved');
